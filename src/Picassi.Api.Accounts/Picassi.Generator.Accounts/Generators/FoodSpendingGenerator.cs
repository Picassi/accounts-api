...
namespace Picassi.Generator.Accounts.Generators
{
    public class FoodSpendingGenerator : IModelDataGenerator
    {
        ...
        public void Generate(DataGenerationContext context)
        {
            ...
            _transactionGenerator.AddTransactions(account, category, 3, 90, "Local Food Shop", 20);
            _transactionGenerator.AddTransactions(account, category, 7, 90, "Weekly Shop", 50);
            _transactionGenerator.AddTransactions(account, category, 6, 90, "Takeawy", 25);
        }
    }
}
