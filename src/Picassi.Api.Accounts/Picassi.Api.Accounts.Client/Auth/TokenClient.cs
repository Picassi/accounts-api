...
namespace Picassi.Api.Accounts.Client.Auth
{
    public class TokenClient : IDisposable
    {
        ...
        public TokenClient(string address, string clientId, string clientSecret,
        ...
        public virtual async Task<TokenResponse> RequestAsync(IDictionary<string, string> form,
            CancellationToken cancellationToken = default(CancellationToken))
        {
            HttpResponseMessage response;

            var request = new HttpRequestMessage(HttpMethod.Post, Address) {Content = new FormUrlEncodedContent(form)};
